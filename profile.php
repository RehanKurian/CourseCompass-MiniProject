...
// Handle the Cropped Image Upload from Cropper.js
...
// Handle Name, Phone, Bio, and Password Update
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_name'])) {
    ...
    // Basic server-side validation remains as a fallback.
...
<head>
    ...
    <style>
        ...
        .info-value input.invalid,
        .info-value textarea.invalid {
            border-color: #e74c3c;
        }
    </style>
</head>
...
<body>
    <section class="profile-section">
        <div class="profile-container">
            ...
            <?php if ($alertMessage): ?>
                <div class="alert-box"><?= htmlspecialchars($alertMessage) ?></div>
            <?php endif; ?>
            ...
            <div class="profile-info">
                <form id="profileForm" method="POST" class="info-card">
                    <h2>Your Profile</h2>
                    <div class="info-grid">
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <input type="text" id="phone_no" name="phone_no" value="<?= htmlspecialchars($phone ?? '') ?>">
                                <div class="error-message"></div>
                            </div>
                        </div>
                        ...
                        <div class="password-wrapper">
                            ...
                            <div class="info-value">
                                ...
                                <button type="button" class="password-toggle" aria-label="Toggle password visibility">
                                    <svg width="20" height="20" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // --- Reusable function to display error messages ---
        ...
        // --- UPDATED: Validation function for Phone Number (must be 10 digits) ---
        const validatePhone = (input) => {
            // ^ asserts start of the string, \d{10} matches exactly 10 digits, $ asserts end of the string.
            const phoneRegex = /^\d{10}$/;
            if (input.value.trim() !== '' && !phoneRegex.test(input.value)) {
                manageError(input, 'Phone number must be 10 digits.');
                return false; 
            }
            manageError(input, ''); // Clears error message if valid or empty
            return true; 
        };
        ...
        profileForm.addEventListener('submit', function(event) {
            ...
            // If any validation fails, stop the form from being submitted.
        ...
        if (passwordToggleBtn && passwordInput) {
            passwordToggleBtn.addEventListener('click', function () {
                if (passwordInput.type === 'password') {
                    ...
                    passwordToggleBtn.querySelector('svg').innerHTML =
